...
public class BlogUser implements UserDetails {
	...
	@JsonIgnore
	@Length(min = MIN_PASSWORD_LENGTH, message = "La contraseña debe tener al menos " + MIN_PASSWORD_LENGTH
			+ " caracteres")
	@NotEmpty(message = "Por favor, introduzca la contraseña")
	@Column(name = "password", nullable = false)
	private String password;

	@NotEmpty(message = "Por favor, introduzca la confirmacion de contraseña")
