...
public class BlogUserServiceImpl implements BlogUserService {
    ...
    public BlogUser saveNewBlogUser(BlogUser blogUser) {
        ...
        if (optionalAuthority.isPresent()) {
            ...
            throw new RuntimeException("Default role no encontrado en el blog con el username " + blogUser.getUsername());
        }
    }
    ...
    public BlogUser findById(Long id) {
        ...
        if (optionalBlogUser.isPresent()) {
            ...
            throw new NoSuchElementException("No se encontró un BlogUser con el ID: " + id);
        }
    }
